        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="list-group">
                    <a href="${pageContext.request.contextPath}/category?method=pageList" class="list-group-item text-center ">生鲜列表</a>
                    <a href="${pageContext.request.contextPath}/category-add.jsp"
                    ...
                    <div class="panel-body">
                        <form action="category" method="post" class="form-horizontal" role="form">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" name="c_name" class="form-control" placeholder="生鲜名称" required>
                                </div>
                                <div class="col-sm-5">
                            ...
                            <div class="form-group" >
                                ...
                                <div class="col-sm-5">
                                    <input type="text" name="place" class="form-control" placeholder="产地" required>
                                </div>
                                <div class="col-sm-5">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <label class="radio-inline">
                                        <input type="radio" name="type" value="0" checked>未知
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="type" value="1">肉类
                                    </label>
                                    <label class="radio-inline">
