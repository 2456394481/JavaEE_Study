		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="list-group">
					<a href="${pageContext.request.contextPath}/category?method=pageList" class="list-group-item text-center active">生鲜列表</a>
						...
						<table class="table table-striped table-responsive table-hover">
							...
							<c:forEach items="${page.list}" var="category">
								<tr>
									...
									<td>
										<%--<a href="">详情</a>--%>
										<a href="${pageContext.request.contextPath}/category?method=deleteCategory&categoryId=${category.categoryId}">删除</a>
										<a href="${pageContext.request.contextPath}/category-update.jsp?categoryId=${category.categoryId}&categoryName=${category.categoryName}&type=${category.type}&place=${category.place}">修改</a>
									</td>
								</tr>
							</c:forEach>
				...
				<nav>
					<ul class="pagination pull-right">
						...
						<c:forEach begin="1" end="${page.totalPage}" var="Page">
							<li><a href="${pageContext.request.contextPath}/category?method=pageList&currentPage=${Page}&currentCount=4">${Page}</a></li>
						</c:forEach>
						<li><a href="#">&raquo;</a></li>
					</ul>
