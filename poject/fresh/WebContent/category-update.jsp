					...
					<div class="panel-body">
						<form action="category" method="post" class="form-horizontal" role="form">
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" name="categoryName" value="${param.categoryName}" class="form-control" placeholder="生鲜名称">
								</div>
								<div class="col-sm-5">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									...
									<label class="radio-inline">
										<input <c:if test="${param.type==1}">checked="checked"</c:if> type="radio" name="type" value="1">肉类
									</label>
									<label class="radio-inline">
										<input <c:if test="${param.type==2}">checked="checked"</c:if> type="radio" name="type" value="2">海鲜水产
									</label>
										<label class="radio-inline">
										<input <c:if test="${param.type==3}">checked="checked"</c:if> type="radio" name="type" value="3">蔬菜
									</label>
								</div>
								<div class="col-sm-5">
